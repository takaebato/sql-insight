...
mod tests {
    ...
    fn flow_passthrough(source: ColumnReference, target: ColumnTarget) -> ColumnLineageEdge {
        ColumnLineageEdge {
            source,
            target,
    ...
    fn flow_transformation(source: ColumnReference, target: ColumnTarget) -> ColumnLineageEdge {
        ColumnLineageEdge {
            source,
            target,
        ...
        fn where_predicate_qualified_ref_is_a_read() {
            assert_column_ops(
                ...
                ColumnOperation {
                    ...
                    reads: vec![read("t1", "a"), read("t1", "b")],
                    writes: vec![],
                    lineage: vec![flow_passthrough(col("t1", "a"), out("a", 0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn derived_table_ref_does_not_surface_in_reads() {
            ...
            assert_column_ops(
                ...
                ColumnOperation {
                    ...
                    writes: vec![],
                    lineage: vec![flow_passthrough(col("t1", "id"), out("id", 0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn predicate_subquery_surfaces_reads_but_no_flow() {
            ...
            assert_column_ops(
                ...
                ColumnOperation {
                    ...
                    writes: vec![],
                    lineage: vec![flow_passthrough(col("t", "a"), out("a", 0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn case_in_where_refs_surface_as_reads() {
            ...
            assert_column_ops(
                ...
                ColumnOperation {
                    ...
                    writes: vec![],
                    lineage: vec![flow_passthrough(col("t", "b"), out("b", 0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn multiple_statements_produce_multiple_results() {
            ...
            assert_nth_column_ops(
                ...
                ColumnOperation {
                    ...
                    reads: vec![read("t2", "b")],
                    writes: vec![],
                    lineage: vec![flow_passthrough(col("t2", "b"), out("b", 0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn select_aliased_column_uses_alias_as_output_name() {
            assert_column_ops(
                ...
                ColumnOperation {
                    ...
                    reads: vec![read("t1", "a")],
                    writes: vec![],
                    lineage: vec![flow_passthrough(col("t1", "a"), out("x", 0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn aggregate_call_in_projection_emits_transformation_flow() {
            assert_column_ops(
                ...
                ColumnOperation {
                    ...
                    reads: vec![read("t1", "a")],
                    writes: vec![],
                    lineage: vec![flow_transformation(col("t1", "a"), out_anon(0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn aggregate_with_alias_carries_aliased_name() {
            assert_column_ops(
                ...
                ColumnOperation {
                    ...
                    reads: vec![read("t1", "b")],
                    writes: vec![],
                    lineage: vec![flow_transformation(col("t1", "b"), out("n", 0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn cte_aggregate_composes_to_outer_as_transformation() {
            ...
            assert_column_ops(
                ...
                ColumnOperation {
                    ...
                    reads: vec![read("t1", "a")],
                    writes: vec![],
                    lineage: vec![flow_transformation(col("t1", "a"), out("s", 0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn cte_column_rename_composes_through_renamed_name() {
            ...
            assert_column_ops(
                ...
                ColumnOperation {
                    ...
                    reads: vec![read("t", "x")],
                    writes: vec![],
                    lineage: vec![flow_passthrough(col("t", "x"), out("a", 0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn aggregate_with_distinct_args_marker() {
            ...
            assert_column_ops(
                ...
                ColumnOperation {
                    ...
                    writes: vec![],
                    lineage: vec![flow_transformation(col("t1", "user_id"), out_anon(0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn insert_values_with_returning_emits_target_reads_and_query_output() {
            assert_column_ops(
                ...
                ColumnOperation {
                    ...
                    reads: vec![read("t", "id")],
                    writes: vec![write("t", "a"), write("t", "b")],
                    lineage: vec![flow_passthrough(col("t", "id"), out("id", 0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn returning_aliased_uses_alias_as_output_name() {
            assert_column_ops(
                ...
                ColumnOperation {
                    ...
                    reads: vec![read("t", "id")],
                    writes: vec![write("t", "a")],
                    lineage: vec![flow_passthrough(col("t", "id"), out("pk", 0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn returning_with_expression_marks_kind_transformation() {
            assert_column_ops(
                ...
                ColumnOperation {
                    ...
                    reads: vec![read("t", "id")],
                    writes: vec![write("t", "a")],
                    lineage: vec![flow_transformation(col("t", "id"), out("bumped", 0))],
                    diagnostics: vec![],
                },
            );
        }
        ...
        fn catalog_disambiguates_join_unqualified_ref() {
            ...
            assert_column_ops_with_catalog(
                ...
                ColumnOperation {
                    ...
                    writes: vec![],
                    lineage: vec![flow_passthrough(col("t2", "a"), out("a", 0))],
                    diagnostics: vec![],
                },
            );
        }
